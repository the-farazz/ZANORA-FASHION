    ...
    <div className="pt-32 pb-20 px-6 md:px-20 bg-zanora-cream min-h-screen">
      ...
      <div className="max-w-[1440px] mx-auto mb-8">
        <div className="flex items-center gap-2 text-[10px] uppercase tracking-widest opacity-40">
          <Link href="/" className="hover:text-zanora-black transition-colors">Home</Link>
          <span>/</span>
          <Link href={`/category/${product.category}`} className="hover:text-zanora-black transition-colors">{product.category.replace('-', ' ')}</Link>
          <span>/</span>
          <span className="text-zanora-black">{product.name}</span>
        </div>
      </div>
